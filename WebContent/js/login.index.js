/* user-passport/1.0.0 login.index.js md5:5e9b73c4d64e5a6297ce513dfe20fe47 */
seajs.use(["user/passport/1.0.0/js/login.username.js", "user/passport/1.0.0/js/login.password.js", "user/passport/1.0.0/js/login.authcode.js", "user/passport/1.0.0/js/login.submit.js", "jdf/1.0.0/ui/placeholder/1.0.0/placeholder", "user/passport/1.0.0/js/login.qrcode.js"], function (a, b, c, d, e, f) {
	a.init(),
	b.init(),
	c.init(),
	f.init(),
