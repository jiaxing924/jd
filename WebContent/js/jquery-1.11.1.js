/* user-reg/1.0.0 jquery-1.11.1.js Date:2016-03-17 14:39:22 */
!function (a, b) {
...
("undefined" != typeof window ? window : this, function (a, b) {
	...
	m.extend({
		dir : function (a, b, c) {
			var d = [],
			e = a[b];
			for (; e && 9 !== e.nodeType && (void 0 === c || 1 !== e.nodeType || !m(e).is(c)); )
	...
	m.event = {
		...
		add : function (a, b, c, d, e) {
			...
			if (r) {
				for (c.handler && (i = c, c = i.handler, e = i.selector), c.guid || (c.guid = m.guid++), (g = r.events) || (g = r.events = {}), (k = r.handle) || (k = r.handle = function (a) {
					...
					}, k.elem = a), b = (b || "").match(E) || [""], h = b.length; h--; )
		...
		fix : function (a) {
			...
			f = a,
			g = this.fixHooks[e];
			for (g || (this.fixHooks[e] = g = Z.test(e) ? this.mouseHooks : Y.test(e) ? this.keyHooks : {}), d = g.props ? this.props.concat(g.props) : this.props, a = new m.Event(f), b = d.length; b--; )
				c = d[b], a[c] = f[c];
			...
			for (; n > q; q++)
				if (f = a[q], f || 0 === f)
					if ("object" === m.type(f))
						...
						for (h = h || o.appendChild(b.createElement("div")), i = (jb.exec(f) || ["", ""])[1].toLowerCase(), l = rb[i] || rb._default, h.innerHTML = l[1] + f.replace(ib, "<$1></$2>") + l[2], e = l[0]; e--; )
							h = h.lastChild;
						if (!k.leadingWhitespace && hb.test(f) && p.push(b.createTextNode(hb.exec(f)[0])), !k.tbody)
							for (f = "table" !== i || kb.test(f) ? "<table>" !== l[1] || kb.test(f) ? 0 : h : h.firstChild, e = f && f.childNodes.length; e--; )
	...
	m.fn.extend({
		...
		empty : function () {
			...
			b = 0;
			for (; null != (a = this[b]); b++) {
				for (1 === a.nodeType && m.cleanData(ub(a, !1)); a.firstChild; )
	...
	m.fn.extend({
		wrapAll : function (a) {
			...
			if (this[0]) {
				...
				b.map(function () {
					var a = this;
					for (; a.firstChild && 1 === a.firstChild.nodeType; )
						a = a.firstChild;
					return a
				}).append(this)
			}
	...
	m.fn.extend({
		...
		offsetParent : function () {
			return this.map(function () {
				...
				for (; a && !m.nodeName(a, "html") && "static" === m.css(a, "position"); )
					a = a.offsetParent;
				return a || cd
			})
		}
