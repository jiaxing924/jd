...
!function (a, b) {
	...
	function L(a) {
		...
		if (a.liveFired !== this && r && r.live && !a.target.disabled && (!a.button || "click" !== a.type)) {
			...
			for (e = f(a.target).closest(q, a.currentTarget), j = 0, k = e.length; k > j; j++)
				for (m = e[j], i = 0; i < s.length; i++)
					g = s[i], m.selector !== g.selector || n && !n.test(g.namespace) || m.elem.disabled || (h = m.elem, d = null, ("mouseenter" === g.preType || "mouseleave" === g.preType) && (a.type = g.preType, d = f(a.relatedTarget).closest(g.selector)[0], d && f.contains(h, d) && (d = h)), d && d === h || p.push({
							"elem" : h,
							"handleObj" : g,
							"level" : m.level
						}));
	...
	function Wb(a, c, d, e, f, g) {
		...
		for (var l, h = a[f], i = 0, j = h ? h.length : 0, k = a === Pb; j > i && (k || !l); i++)
			l = h[i](c, d, e), "string" == typeof l && (!k || g[l] ? l = b : (c.dataTypes.unshift(l), l = Wb(a, c, d, e, l, g)));
	...
	f = function () {
		...
		return e.fn = e.prototype = {
			...
			"init" : function (a, d, f) {
				...
				if ("string" == typeof a) {
					if (g = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && a.length >= 3 ? [null, a, null] : i.exec(a), !g || !g[1] && d)
						return !d || d.jquery ? (d || f).find(a) : this.constructor(d).find(a);
					if (g[1])
						return d = d instanceof e ? d[0] : d, k = d ? d.ownerDocument || d : c, j = n.exec(a), j ? e.isPlainObject(d) ? (a = [c.createElement(j[1])], e.fn.attr.call(a, d, !0)) : a = [k.createElement(j[1])] : (j = e.buildFragment([g[1]], [k]), a = (j.cacheable ? e.clone(j.fragment) : j.fragment).childNodes), e.merge(this, a);
		...
		e.extend = e.fn.extend = function () {
			...
			for ("boolean" == typeof i && (l = i, i = arguments[1] || {}, j = 2), "object" == typeof i || e.isFunction(i) || (i = {}), k === j && (i = this, --j); k > j; j++)
				if (null != (a = arguments[j]))
					for (c in a)
						d = i[c], f = a[c], i !== f && (l && f && (e.isPlainObject(f) || (g = e.isArray(f))) ? (g ? (g = !1, h = d && e.isArray(d) ? d : []) : h = d && e.isPlainObject(d) ? d : {}, i[c] = e.extend(l, h, f)) : f !== b && (i[c] = f));
			return i
		},
		e.extend({
			...
			"ready" : function (a) {
				if (a === !0 && !--e.readyWait || a !== !0 && !e.isReady) {
					...
					if (e.isReady = !0, a !== !0 && --e.readyWait > 0)
						return;
					B.resolveWith(c, [e]),
			...
			"bindReady" : function () {
				if (!B) {
					if (B = e._Deferred(), "complete" === c.readyState)
						return setTimeout(e.ready, 1);
			...
			e = {
				"done" : function () {
					if (!d) {
						...
						k,
						c = arguments;
						for (b && (k = b, b = 0), g = 0, h = c.length; h > g; g++)
							i = c[g], j = f.type(i), "array" === j ? e.done.apply(e, i) : "function" === j && a.push(i);
	...
	f.support = function () {
		...
		b = c.documentElement;
		if (a.setAttribute("className", "t"), a.innerHTML = "   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", d = a.getElementsByTagName("*"), e = a.getElementsByTagName("a")[0], !d || !d.length || !e)
			return {};
		...
		"data" : function (a, c, d, e) {
			if (f.acceptData(a)) {
				...
				if (!(!m || e && m && l[m] && !l[m][i]) || !j || d !== b)
					return m || (k ? a[f.expando] = m = ++f.uuid : m = f.expando), l[m] || (l[m] = {}, k || (l[m].toJSON = f.noop)), ("object" == typeof c || "function" == typeof c) && (e ? l[m][i] = f.extend(l[m][i], c) : l[m] = f.extend(l[m], c)), g = l[m], e && (g[i] || (g[i] = {}), g = g[i]), d !== b && (g[f.camelCase(c)] = d), "events" !== c || g[c] ? (j ? (h = g[c], null == h && (h = g[f.camelCase(c)])) : h = g, h) : g[i] && g[i].events
			}
		},
	...
	f.fn.extend({
		"data" : function (a, c) {
			...
			if ("undefined" == typeof a) {
				if (this.length && (d = f.data(this[0]), 1 === this[0].nodeType))
					for (var g, e = this[0].attributes, h = 0, i = e.length; i > h; h++)
						g = e[h].name, 0 === g.indexOf("data-") && (g = f.camelCase(g.substring(5)), k(this[0], g, d[g]));
				return d
			}
			if ("object" == typeof a)
			...
			var j = a.split(".");
			return j[1] = j[1] ? "." + j[1] : "",
			c === b ? (d = this.triggerHandler("getData" + j[1] + "!", [j[0]]), d === b && this.length && (d = f.data(this[0], a), d = k(this[0], a, d)), d === b && j[1] ? this.data(j[0]) : d) : this.each(function () {
				var b = f(this),
				d = [j[0], c];
	...
	f.fn.extend({
		...
		"promise" : function (a, c) {
			...
			for (var l, d = f.Deferred(), e = this, g = e.length, h = 1, i = a + "defer", j = a + "queue", k = a + "mark"; g--; )
				(l = f.data(e[g], i, b, !0) || (f.data(e[g], j, b, !0) || f.data(e[g], k, b, !0)) && f.data(e[g], i, f._Deferred(), !0)) && (h++, l.done(m));
			return m(),
			d.promise()
		}
	});
	...
	f.fn.extend({
				...
				for (b = a.split(o), c = 0, d = this.length; d > c; c++)
					if (e = this[c], 1 === e.nodeType)
						if (e.className || 1 !== b.length) {
							for (g = " " + e.className + " ", h = 0, i = b.length; i > h; h++)
								~g.indexOf(" " + b[h] + " ") || (g += b[h] + " ");
			...
			if (a && "string" == typeof a || a === b)
				for (c = (a || "").split(o), d = 0, e = this.length; e > d; d++)
					if (g = this[d], 1 === g.nodeType && g.className)
						if (a) {
							for (h = (" " + g.className + " ").replace(n, " "), i = 0, j = c.length; j > i; i++)
								h = h.replace(" " + c[i] + " ", " ");
		...
		"val" : function (a) {
			...
			e = this[0];
			if (!arguments.length)
				return e ? (c = f.valHooks[e.nodeName.toLowerCase()] || f.valHooks[e.type], c && "get" in c && (d = c.get(e, "value")) !== b ? d : (d = e.value, "string" == typeof d ? d.replace(p, "") : null == d ? "" : d)) : b;
	...
	f.extend({
		...
		"attr" : function (a, c, d, e) {
			...
			i,
			j = 1 !== g || !f.isXMLDoc(a);
			return j && (c = f.attrFix[c] || c, i = f.attrHooks[c], i || (t.test(c) ? i = v : u && (i = u))),
			d !== b ? null === d ? (f.removeAttr(a, c), b) : i && "set" in i && j && (h = i.set(a, d, c)) !== b ? h : (a.setAttribute(c, "" + d), d) : i && "get" in i && j && null !== (h = i.get(a, c)) ? h : (h = a.getAttribute(c), null === h ? b : h)
		},
		...
		"prop" : function (a, c, d) {
			...
			h,
			i = 1 !== e || !f.isXMLDoc(a);
			return i && (c = f.propFix[c] || c, h = f.propHooks[c]),
	...
	f.event = {
			...
			if (3 !== a.nodeType && 8 !== a.nodeType) {
				...
				if (i) {
					...
					for (var l, n, m = 0; l = c[m++]; ) {
						...
						var o = j[l],
						p = f.event.special[l] || {};
						o || (o = j[l] = [], p.setup && p.setup.call(a, e, n, k) !== !1 || (a.addEventListener ? a.addEventListener(l, k, !1) : a.attachEvent && a.attachEvent("on" + l, k))),
							...
							if (r = h, q = null, l = h.indexOf(".") < 0, m = [], l || (m = h.split("."), h = m.shift(), n = new RegExp("(^|\\.)" + f.map(m.slice(0).sort(), B).join("\\.(?:.*\\.)?") + "(\\.|$)")), p = t[h])
								if (d) {
									...
									for (j = 0; j < p.length; j++)
										q = p[j], (l || n.test(q.namespace)) && (f.event.remove(a, r, q.handler, j), p.splice(j--, 1));
		...
		"trigger" : function (c, d, e, g) {
			...
			if (h.indexOf("!") >= 0 && (h = h.slice(0, -1), j = !0), h.indexOf(".") >= 0 && (i = h.split("."), h = i.shift(), i.sort()), e && !f.event.customEvent[h] || f.event.global[h]) {
				if (c = "object" == typeof c ? c[f.expando] ? c : new f.Event(h, c) : new f.Event(h), c.type = h, c.exclusive = j, c.namespace = i.join("."), c.namespace_re = new RegExp("(^|\\.)" + i.join("\\.(?:.*\\.)?") + "(\\.|$)"), (g || !e) && (c.preventDefault(), c.stopPropagation()), !e)
		...
		"handle" : function (c) {
			...
			for (var h = 0, i = d.length; i > h; h++) {
				...
				if (e || c.namespace_re.test(j.namespace)) {
					...
					if (k !== b && (c.result = k, k === !1 && (c.preventDefault(), c.stopPropagation())), c.isImmediatePropagationStopped())
						break
				}
			}
			return c.result
	...
	f.each(["bind", "one"], function (a, c) {
		f.fn[c] = function (a, d, e) {
			...
			if ((2 === arguments.length || d === !1) && (e = d, d = b), "one" === c ? (g = function (a) {
				...
				}, g.guid = e.guid || f.guid++) : g = e, "unload" === a && "one" !== c)
				this.one(a, d, e);
			else
		...
		var k = function (b, d, f, g) {
			...
			if (x.length > 1 && m.exec(b))
				...
				for (q = g ? {
					 ...
					 : k.find(x.pop(), 1 !== x.length || "~" !== x[0] && "+" !== x[0] || !d.parentNode ? d : d.parentNode, w), j = q.expr ? k.filter(q.expr, q.set) : q.set, x.length > 0 ? n = p(j) : u = !1; x.length; )
					r = x.pop(), s = r, l.relative[r] ? s = x.pop() : r = "", null == s && (s = d), l.relative[r](n, s, w);
			else
				n = x = [];
			if (n || (n = j), n || k.error(r || b), "[object Array]" === e.call(n))
				...
				p(n, f);
			return o && (k(o, h, f, g), k.uniqueSort(f)),
			f
		};
			...
			for (var f, g, h = a, i = [], j = c, m = c && c[0] && k.isXML(c[0]); a && c.length; ) {
				for (var n in l.filter)
					if (null != (f = l.leftMatch[n].exec(a)) && f[2]) {
						...
						q = l.filter[n],
						r = f[1];
						if (g = !1, f.splice(1, 1), "\\" === r.substr(r.length - 1))
							continue;
						...
						if (o !== b) {
							if (d || (j = i), a = a.replace(l.match[n], ""), !g)
								return [];
							break
						}
					}
		...
		var l = k.selectors = {
			...
			"relative" : {
				...
				"" : function (a, b, c) {
					...
					f = d++,
					g = u;
					"string" != typeof b || j.test(b) || (b = b.toLowerCase(), e = b, g = t),
		...
		function () {
			...
			if (b) {
				...
				k.matchesSelector = function (a, c) {
					if (c = c.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']"), !k.isXML(a))
						try {
		...
		"closest" : function (a, b) {
			...
			for (d = 0, e = this.length; e > d; d++)
				for (g = this[d]; g; ) {
					...
					if (g = g.parentNode, !g || !g.ownerDocument || g === b || 11 === g.nodeType)
						break
				}
	...
	f.fn.extend({
		...
		"remove" : function (a, b) {
			for (var d, c = 0; null != (d = this[c]); c++)
				(!a || f.filter(a, [d]).length) && (b || 1 !== d.nodeType || (f.cleanData(d.getElementsByTagName("*")), f.cleanData([d])), d.parentNode && d.parentNode.removeChild(d));
			return this
		},
		"empty" : function () {
			...
			if ("string" != typeof a || ab.test(a) || !f.support.leadingWhitespace && X.test(a) || eb[(Z.exec(a) || ["", ""])[1].toLowerCase()])
				...
				try {
					for (var c = 0, d = this.length; d > c; c++)
						1 === this[c].nodeType && (f.cleanData(this[c].getElementsByTagName("*")), this[c].innerHTML = a)
				} catch (e) {
					this.empty().append(a)
				}
			}
	...
	f.buildFragment = function (a, b, d) {
		...
		1 === a.length && "string" == typeof a[0] && a[0].length < 512 && i === c && "<" === a[0].charAt(0) && !ab.test(a[0]) && (f.support.checkClone || !bb.test(a[0])) && (g = !0, h = f.fragments[a[0]], h && 1 !== h && (e = h)),
	...
	f.extend({
		"clone" : function (a, b, c) {
			...
			if (!(f.support.noCloneEvent && f.support.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || f.isXMLDoc(a)))
				for (hb(a, d), e = ib(a), g = ib(d), h = 0; e[h]; ++h)
					g[h] && hb(e[h], g[h]);
			if (b && (gb(a, d), c))
				for (e = ib(a), g = ib(d), h = 0; e[h]; ++h)
					gb(e[h], g[h]);
			return e = g = null,
			d
		},
	...
	f.extend({
		...
		"style" : function (a, c, d, e) {
			if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
				...
				if (h = typeof d, "string" === h && (g = rb.exec(d)) && (d =  + (g[1] + 1) * +g[2] + parseFloat(f.css(a, c)), h = "number"), !(null == d || "number" === h && isNaN(d) || ("number" !== h || f.cssNumber[i] || (d += "px"), k && "set" in k && (d = k.set(a, d)) === b)))
					try {
						j[c] = d
					} catch (l) {}
			}
	...
	f.support.opacity || (f.cssHooks.opacity = {
			...
			"set" : function (a, b) {
				...
				c.zoom = 1,
				b >= 1 && "" === f.trim(g.replace(mb, "")) && (c.removeAttribute("filter"), d && !d.filter) || (c.filter = mb.test(g) ? g.replace(mb, e) : g + " " + e)
			}
		}),
	f(function () {
	...
	c.defaultView && c.defaultView.getComputedStyle && (wb = function (a, c) {
		...
		(e = a.ownerDocument.defaultView) ? ((g = e.getComputedStyle(a, null)) && (d = g.getPropertyValue(c), "" !== d || f.contains(a.ownerDocument.documentElement, a) || (d = f.style(a, c))), d) : b
	}),
	c.documentElement.currentStyle && (xb = function (a, b) {
		...
		f = a.style;
		return !pb.test(d) && qb.test(d) && (c = f.left, e && (a.runtimeStyle.left = a.currentStyle.left), f.left = "fontSize" === b ? "1em" : d || 0, d = f.pixelLeft + "px", f.left = c, e && (a.runtimeStyle.left = e)),
		"" === d ? "auto" : d
	}),
	vb = wb || xb,
	...
	f.extend({
		...
		"ajaxSetup" : function (a, b) {
			return b ? Xb(a, f.ajaxSettings) : (b = a, a = f.ajaxSettings),
			Xb(a, b),
			a
		},
		"ajaxSettings" : {
		...
		"ajax" : function (a, c) {
			function w(a, c, l, m) {
				if (2 !== s) {
					...
					if (a >= 200 && 300 > a || 304 === a)
						if (d.ifModified && ((y = v.getResponseHeader("Last-Modified")) && (f.lastModified[k] = y), (z = v.getResponseHeader("Etag")) && (f.etag[k] = z)), 304 === a)
							w = "notmodified", o = !0;
						else
							try {
								r = $b(d, x),
			...
			if (h.promise(v), v.success = v.done, v.error = v.fail, v.complete = i.done, v.statusCode = function (a) {
				...
				return this
			}, d.url = ((a || d.url) + "").replace(Cb, "").replace(Hb, Sb[1] + "//"), d.dataTypes = f.trim(d.dataType || "*").toLowerCase().split(Lb), null == d.crossDomain && (r = Nb.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == Sb[1] && r[2] == Sb[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (Sb[3] || ("http:" === Sb[1] ? 80 : 443)))), d.data && d.processData && "string" != typeof d.data && (d.data = f.param(d.data, d.traditional)), Wb(Pb, d, c, v), 2 === s)
				return !1;
		...
		"param" : function (a, c) {
			...
			if (c === b && (c = f.ajaxSettings.traditional), f.isArray(a) || a.jquery && !f.isPlainObject(a))
				f.each(a, function () {
	...
	f.ajaxPrefilter("json jsonp", function (b, c, d) {
		...
		if ("jsonp" === b.dataTypes[0] || b.jsonp !== !1 && (ac.test(b.url) || e && ac.test(b.data))) {
			...
			k = b.data,
			l = "$1" + h + "$2";
			return b.jsonp !== !1 && (j = j.replace(ac, l), b.url === j && (e && (k = k.replace(ac, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
			b.url = j,
			b.data = k,
			a[h] = function (a) {
				g = [a]
					...
					d = function (a, e) {
						...
						try {
							if (d && (e || 4 === h.readyState))
								if (d = b, i && (h.onreadystatechange = f.noop, bc && delete dc[i]), e)
	...
	f.fn.extend({
		"show" : function (a, b, c) {
			...
			for (var g = 0, h = this.length; h > g; g++)
				d = this[g], d.style && (e = d.style.display, f._data(d, "olddisplay") || "none" !== e || (e = d.style.display = ""), "" === e && "none" === f.css(d, "display") && f._data(d, "olddisplay", rc(d.nodeName)));
			for (g = 0; h > g; g++)
				d = this[g], d.style && (e = d.style.display, ("" === e || "none" === e) && (d.style.display = f._data(d, "olddisplay") || ""));
			return this
		},
		"hide" : function (a, b, c) {
			if (a || 0 === a)
		...
		"animate" : function (a, b, c, d) {
			...
			return f.isEmptyObject(a) ? this.each(e.complete, [!1]) : (a = f.extend({}, a), this[e.queue === !1 ? "each" : "queue"](function () {
					...
					for (i in a) {
						if (g = f.camelCase(i), i !== g && (a[g] = a[i], delete a[i]), h = a[g], f.isArray(h) ? (b.animatedProperties[g] = h[1], h = a[g] = h[0]) : b.animatedProperties[g] = b.specialEasing && b.specialEasing[g] || b.easing || "swing", "hide" === h && d || "show" === h && !d)
					...
					for (i in a)
						k = new f.fx(this, b, i), h = a[i], jc.test(h) ? k["toggle" === h ? d ? "show" : "hide" : h]() : (l = kc.exec(h), m = k.cur(), l ? (n = parseFloat(l[2]), o = l[3] || (f.cssNumber[i] ? "" : "px"), "px" !== o && (f.style(this, i, (n || 1) + o), m = (n || 1) / k.cur() * m, f.style(this, i, m + o)), l[1] && (n = ("-=" === l[1] ? -1 : 1) * n + m), k.custom(m, n, o)) : k.custom(m, h, ""));
					return !0
				}))
		},
		"stop" : function (a, b) {
	...
	f.fx.prototype = {
		...
		"step" : function (a) {
			...
			return 1 / 0 == e.duration ? this.now = b : (h = b - this.startTime, this.state = h / e.duration, this.pos = f.easing[e.animatedProperties[this.prop]](this.state, h, 0, 1, e.duration), this.now = this.start + (this.end - this.start) * this.pos),
			this.update(),
			!0
		}
	},
	...
	f.fn.offset = "getBoundingClientRect" in c.documentElement ? function (a) {
	 ...
	 : function (a) {
		...
		return ("relative" === k.position || "static" === k.position) && (l += i.offsetTop, m += i.offsetLeft),
		f.offset.supportsFixedPosition && "fixed" === k.position && (l += Math.max(h.scrollTop, i.scrollTop), m += Math.max(h.scrollLeft, i.scrollLeft)), {
			"top" : l,
			"left" : m
		}
	},
